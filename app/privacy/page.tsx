    ...
    <main className="legal-page">
      ...
      <article className="legal container">
        ...
        <p className="text-secondary">
          {tr
            ? <>Sorularınız için: <a href={`mailto:${CONTACT}`}>{CONTACT}</a>. Ayrıca <Link href="/terms">Kullanım Koşulları</Link>'na bakın.</>
            : <>Questions? <a href={`mailto:${CONTACT}`}>{CONTACT}</a>. See also our <Link href="/terms">Terms of Service</Link>.</>}
        </p>
...
function EN() {
  return (
    <>
      ...
      <h2>3. Email finding &amp; web scraping</h2>
      <p>
...
function TR() {
  return (
    <>
      ...
      <h2>3. E-posta bulma &amp; web taraması</h2>
      <p>
      ...
      <h2>4. Veri paylaştığımız üçüncü taraflar</h2>
